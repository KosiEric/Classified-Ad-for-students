<div id = "submit-ad-container"><?php /* <div class="post-inner">
  ...
  Photos with contact details are not permitted.</span>
    ...
    <input type = "file" name = "image1" form="ad-image-1-form" data-upload-new-image = "0" id = "image1" data-image-number = "1"  class = "imageFiles ad-image-fields" accept="image/jpeg,image/gif,image/png" />

    <label for = "image1" class = "image-labels" id = "image1-label" title="ad featured image" style="background-image: url(<?php echo "{$functions->getAdImages($ad_id)[0]}"; ?>);">
        <button type="submit" class="ad-change-image-buttons" data-image-number = "1" id = "image-1-upload-button" form="ad-image-1-form">upload</button>

        <i class="fa fa-camera label-camera" id = "image1-camera"></i>
    </label>
    <input type = "file" name = "image2" id = "image2"  data-image-number = "2" form="ad-image-2-form" class = "imageFiles ad-image-fields" accept="image/jpeg,image/gif,image/png" />

    <label for = "image2" class = "image-labels" id = "image2-label" title="Select 2nd image" style="background-image: url(<?php echo "{$functions->getAdImages($ad_id)[1]}"; ?>);">

        <button type="submit" class="ad-change-image-buttons" data-image-number = "2" id = "image-2-upload-button" form="ad-image-2-form">upload</button>

        <i id = "image2-camera" class="fa fa-camera label-camera"></i>

    </label>
    <input type = "file"  name = "image3" id = "image3" form="ad-image-3-form" class = "imageFiles ad-image-fields" data-image-number = "3" name = "file[]"  accept="image/jpeg,image/gif,image/png"/>


    <label for = "image3" class = "image-labels" id = "image3-label" title="Select 3rd image"  style="background-image: url(<?php echo "{$functions->getAdImages($ad_id)[2]}"; ?>);">
        <button type="submit" class="ad-change-image-buttons" data-image-number = "3" id = "image-3-upload-button" form="ad-image-3-form">upload</button>
