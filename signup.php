...
$page_title = "Create an account  • {$home_page_site_name} ";
$page_description = "Create an account with {$home_page_site_name}.com ";
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SITE_CONFIGURATIONS['CSS_FOLDER']?>signup.css" />
    <!-- font -->
    <!-- favicon icon -->
    ...
    <div class="avt-post-wrapper section">
        ...
        <div class="container">
            ...
            <div class="avt-post" >
                ...
                <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'signup.php'; ?>
