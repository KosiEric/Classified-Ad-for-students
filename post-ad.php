...
$page_title = "Post Free Ad  • {$home_page_site_name} ";
    ...
    <div class="avt-post-wrapper section">
        ...
        <div class="container">
            ...
            <div class="avt-post" >
                    ...
                    <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'browser-warning.php'; ?>
                                <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'steps-container.php'; ?>
                    ...
                    <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'login-container.php'; ?>
                <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'product-detail-container.php'; ?>
                <?php require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'seller-information-container.php'; ?>
                <?php //require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'sell.php'; ?>


                <?php //require_once SITE_CONFIGURATIONS["HTML_FOLDER"].'add-featured-container.php'; ?>





                        <div class="submit-section hideable-forms">
