...
$countries = Array("Nigeria" => Array("currency" => "Naira" , "currency_sign" => "&#8358;" , "helpline" => "+234 (0) 70 844 195 30" /*"+1 (423)  516   039 6"*/ , "reference" => 'Nigerians' ,  'head_office' => "Block 2A Quarters 3,  Port Harcourt Int'l Airport, Rivers Nigeria."));
define("SITE_CONFIGURATIONS" , Array("SITE_AUTHOR" => "Kosi Eric" , "CONTACT_EMAIL" => "support@gmail.com" , "IMG_FOLDER" => STATIC_FOLDER."img/", "FORMS_FOLDER" => STATIC_FOLDER."forms/", "HTML_FOLDER" => $document_root."/".STATIC_FOLDER."html/" ,   "JS_FOLDER" => STATIC_FOLDER."js/", "CSS_FOLDER" => STATIC_FOLDER."css/" , "SITE_LOGO" => STATIC_FOLDER."img/favicon.ico" ,
